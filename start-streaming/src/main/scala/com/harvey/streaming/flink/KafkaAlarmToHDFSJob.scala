...
object KafkaAlarmToHDFSJob {
  ...
  val template = s"%s$COLUMN_DELIMITED%s$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%s$COLUMN_DELIMITED%s$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%s$COLUMN_DELIMITED%s$COLUMN_DELIMITED%f$COLUMN_DELIMITED%f$COLUMN_DELIMITED%f$COLUMN_DELIMITED%f$COLUMN_DELIMITED%s$COLUMN_DELIMITED%b$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%f$COLUMN_DELIMITED%f$COLUMN_DELIMITED%f$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%s$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%s$COLUMN_DELIMITED%d$COLUMN_DELIMITED%d$COLUMN_DELIMITED%s$COLUMN_DELIMITED%s"
  ...
  def main(args: Array[String]): Unit = {
    ...
    env.addSource(consumer).map(m => {
      ...
      template.format(m.getProcessKey, m.getDevID, m.getDevItnlID, m.getVehicleItnlID, m.getDriverItnlID,
        ...
        position.getAngle, actionTime, actionHour, 0, 0, 0, 0, 0, "", -1, 0, "", 0, 0, "AI", alarm.getAlertType
      )
    }).addSink(sink)
